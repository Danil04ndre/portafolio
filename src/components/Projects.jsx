    ...
    <section className="content-projects" id="projects">
      ...
      <div className="item-project">
        <div className="info">
          <h3>Ecommerce 2.0</h3>
          <p>
            Un proyecto mejorado despues de aprender nuevas tecnologias como
            redux, jwt entre otras validaciones y buenas practicas
          </p>
          <figure>
            <img src={react} alt="React" />
            <img src={node} alt="JavaScript" />
            <img
              src="https://logowik.com/content/uploads/images/redux.jpg"
              alt="JavaScript"
              className="mysql"
            />
          ...
          <a
            href="https://ecommerce-three-sooty.vercel.app/"
            className="link-page"
            target="_blank"
            rel="noreferrer"
          >
        ...
        <div className="video image-project">
          <img
            className="a"
            src={!movieImage ? ecommerce : ecommerce2}
